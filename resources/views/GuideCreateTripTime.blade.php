...
<div class="container">
	...
	function first(){     
		var wrapper = $("<div id=\"field"+id+"\" class='form-inline'>");
		var text    = $("<div class='col-2'><span>Time</span><input type='time' class='form-control' name=\"time"+timeid+"\" /></div>");
	...
	function day(){
        ...
        timeid=1;
		var wrapper = $("<div id=\"field"+id+"\" class='form-inline'>");
		var text    = $("<div class='col-2'><input type='time' class='form-control' name=\"time"+timeid+"\" /></div>");
    ...
    function time(){
        timeid++;
        if(timeid<=10){
            var text    = $("<div id=\"field"+timeid+"\" class='form-inline'><div class='col-2'><input type='time' class='form-control' name=\"time"+timeid+"\" /></div>");
