...
class ChatController extends Controller
{
    ...
    public function ShowChatPage(){
        if(Session::get('guideid')){
            ...
            $chatList = DB::select("select * from ChatRoom c join Tourist t on c.guideId=t.touristId join Tourist t on c.touristId=t.touristId join Users gu on g.username=gu.username where c.touristId=".$touristId." group by c.chatRoomId desc");
