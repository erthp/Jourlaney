...
class OrderController extends Controller
{
    ...
    public function ConfirmOrder(Request $request){
        ...
        $today = Carbon::today('Asia/Bangkok')->isoFormat('DD MMMM YYYY');
        $tourist = DB::select("select u.userLastName, u.userFirstName, u.userEmail from TripOrder ord join ChatRoom c on ord.chatRoomId=c.chatRoomId join Tourist t on c.touristId=t.touristId join Users u on t.username=u.username where c.chatRoomId=".$chatRoomId);
        $guide = DB::select("select u.userLastName, u.userFirstName, u.userEmail from TripOrder ord join ChatRoom c on ord.chatRoomId=c.chatRoomId join Guide g on c.guideId=g.guideId join Users u on g.username=u.username where c.chatRoomId=".$chatRoomId);
        $order = DB::select("select * from GuideTrip gt join ChatRoom c on gt.tripId=c.guideTripId join TripOrder ord on ord.chatRoomId=c.chatRoomId where c.chatRoomId=".$chatRoomId);
        $touristFirstName = $tourist[0]->userFirstName;
        $touristLastName = $tourist[0]->userLastName;
        $touristEmail = $tourist[0]->userEmail;
        $guideFirstName = $guide[0]->userFirstName;
        $guideLastName = $guide[0]->userLastName;
        $guideEmail = $guide[0]->userEmail;
        $orderTripName = $order[0]->tripName;
        $orderTripCost = $order[0]->tripCost;
        $orderTripCostWithVAT = $order[0]->tripCostWithVat;
        $orderServiceCharge = ($orderTripCost * 10) / 100;
        $orderVAT = ($orderTripCost * 7) / 100;
        ...
        try {
            ...
            //Content
            $mail->isHTML(true);                                  // Set email format to HTML
            $mail->Subject = 'Jourlaney Reciept';
            $mail->Body    = '<!DOCTYPE html>
            <html lang="en" xmlns="http://www.w3.org/1999/xhtml" xmlns:v="urn:schemas-microsoft-com:vml" xmlns:o="urn:schemas-microsoft-com:office:office">
            <head>
                <meta charset="utf-8">
                        ...
                        <tr>
                            <td style="background-color: #ffffff;">
                                <table role="presentation" cellspacing="0" cellpadding="0" border="0" width="100%">
                                    ...
                                    <tr>
                                        <td style="padding: 20px; font-family: sans-serif; font-size: 15px; line-height: 20px; color: #555555;">
                                            <p style="margin: 0 0 10px;">Guide</p>
                                            <ul style="padding: 0; margin: 0; list-style-type: disc;">
                                                <li style="margin:0 0 10px 20px;" class="list-item-first">Guide Name: '.$guideLastName.', '.$guideFirstName.'</li>
                                                <li style="margin:0 0 10px 20px;" class="list-item-last">Guide Email: '.$guideEmail.'</li>
                                            </ul>
                                        </td>
                                        <td style="padding: 20px; font-family: sans-serif; font-size: 15px; line-height: 20px; color: #555555;">
                                            <p style="margin: 0 0 10px;">Tourist</p>
                                            <ul style="padding: 0; margin: 0; list-style-type: disc;">
                                                <li style="margin:0 0 10px 20px;" class="list-item-first">Tourist Name: '.$touristLastName.', '.$touristFirstName.'</li>
                                                <li style="margin:0 0 10px 20px;" class="list-item-last">Tourist Email: '.$touristEmail.'</li>
                                            </ul>
                                        </td>
                                    </tr>
                                </table>
                            ...
                            <td style="background-color: #ffffff;">
                                <table role="presentation" cellspacing="0" cellpadding="0" border="0" width="100%">
                                    ...
                                    <tr>
                                        ...
                                        <td style="font-family: sans-serif; font-size: 15px; line-height: 20px; color: #555555;">
                                            Jourlaney Service Charge 
                                        </td>
                                        <td style="font-family: sans-serif; font-size: 15px; line-height: 20px; color: #555555;">
                                            1
                                        </td>
                                        <td style="font-family: sans-serif; font-size: 15px; line-height: 20px; color: #555555;">
                                            -THB '.$orderServiceCharge.'.00
                                        </td>
                                        <td style="font-family: sans-serif; font-size: 15px; line-height: 20px; color: #555555;">
                                            -THB '.$orderServiceCharge.'.00
                                        </td>
                        ...
                        <tr>
                            <td style="background-color: #ffffff;">
                                <table role="presentation" cellspacing="0" cellpadding="0" border="0" width="100%">
                                    <tr>
                                        <td style="padding: 20px; font-family: sans-serif; font-size: 15px; line-height: 20px; color: #555555;">
                                            Payment completed. Meet up with guide in your selected time and place.<br>
                                            Have a good trip :)
                                        </td>
                                    </tr>
                                </table>
