...
class IndexController extends Controller
{
    public function getdata(){
        ...
        return view('index')->with('guideTrips',$queryGuideTrips)->with('upcomingGuideTrips',$queryUpcomingGuideTrips)->with('today',$today)->with('next6',$next6)->with('next7',$next7)->with('next12',$next12);
    }
}
